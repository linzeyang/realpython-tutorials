...
You can install the Real Python Feed Reader from [PyPI test](https://test.pypi.org/project/zeyanglin-test-realpython-reader/):

    pip install -i https://test.pypi.org/simple/ zeyanglin-test-realpython-reader

The reader is supported on Python 3.9 and above.
